...
posts = [
    ...
    },
    {
        ...
        'category': 'not-my-day',
        'text': (
            'Проснувшись поутру, я увидел, что наш корабль сняло с мели приливом '
            'и пригнало гораздо ближе к берегу. Это подало мне надежду, что, '
            'когда ветер стихнет, мне удастся добраться до корабля и запастись '
    ...
    },
    {
        ...
        'text': (
            ...
            '25 октября. Корабль за ночь разбило в щепки; на том месте, где он '
            'стоял, торчат какие‑то жалкие обломки, да и те видны только во '
            'время отлива. Весь этот день я хлопотал около вещей: укрывал и '
