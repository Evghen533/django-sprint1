...
posts = [
    ...
    },
    {
        ...
        "location": "Остров отчаянья",
        "title": "Строю плот",
        "text": "Проснувшись поутру, я увидел, что наш корабль сняло с мели приливом и пригнало гораздо ближе к берегу. Это подало мне надежду, что, воспользовавшись приливом, я смогу добыть из корабля всё необходимое для жизни."
    },
    {
        "id": 2,
        "category": "not-my-day",
        ...
        "location": "Остров отчаянья",
        "title": "Ураган",
        "text": "Всю ночь и весь день шёл дождь и дул сильный порывистый ветер. Корабль за ночь разбило в щепки; на том месте, где он стоял, торчат какие-то жалкие обломки, да и те видны только во время отлива."
    }
]
