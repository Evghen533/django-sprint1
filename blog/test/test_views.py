...
class ViewsTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.cat_not_my_day = Category.objects.create(title="Not My Day", slug="not-my-day")
    ...
    def test_post_detail_valid(self):
        for post in Post.objects.all():
            ...
            self.assertEqual(response.status_code, 200, f'Post {post.pk} should be 200')
    ...
    def test_category_not_my_day(self):
        ...
        # НЕ проверяем 'Корабль сняло с мели', он в категории adventure
